    ...
    public void eliAlumno(View v){
        ...
        if(network != null && cm.getNetworkCapabilities(cm.getActiveNetwork()) != null ){
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
                    String url = "http://10.0.2.2/Programacion_web/Pruebas_PHP/Sistema_ABCC/API_REST_Mysql/api_eliminar.php";
                    String metodo = "POST";
